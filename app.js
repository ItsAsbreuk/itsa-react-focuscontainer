...
const React = require("react"),
    ...
    FocusContainer = require("./lib/component.jsx");

ReactDOM.render(
    <FocusContainer className="fc-1" transitionTime={1000} >
        <div>
            <input className="fc-1-input-1" type="text" />
            <input className="fc-1-input-2" type="text" />
            <input className="fc-1-input-3" type="text" />
            <button>Press me</button>
            <FocusContainer className="fc-2" keyEnter={39} focusOnContainerClick={true} >
                <input className="fc-2-input-1" type="text" />
                <input className="fc-2-input-2" type="text" />
                <input className="fc-2-input-3" type="text" />
                <button>Press me</button>
            </FocusContainer>
        </div>
    </FocusContainer>,
...
const Input = require("itsa-react-input"),
